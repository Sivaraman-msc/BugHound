...
export default function AuthNavBar({ variant = 'login' }) {
  ...
  return (
    <nav className="w-full px-4 bg-blue-900 flex flex-col lg:flex-row items-center justify-between z-50">
      ...
      <ul className={`${isOpen ? 'absolute left-3 w-30 top-15 ml-60 bg-gray-700 shadow-md p-4 rounded-md z-50 flex flex-col' : 'hidden'} lg:flex lg:static lg:flex-row lg:items-center gap-4 lg:gap-8 mt-4 lg:mt-0 text-white font-medium text-md lg:text-lg `}>
